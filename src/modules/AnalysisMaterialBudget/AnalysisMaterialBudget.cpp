...
void AnalysisMaterialBudget::initialize() {
    ...
    trackKinkX = new TH1F("trackKinkX", "Track Kink X; kink x [mrad]; Tracks", 2000, -200, 200);
    trackKinkY = new TH1F("trackKinkY", "Track Kink Y; kink y [mrad]; Tracks", 2000, -200, 200);
