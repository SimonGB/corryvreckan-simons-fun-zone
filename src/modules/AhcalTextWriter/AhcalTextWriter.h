/**
 * @file
 * @brief Definition of module AhcalTextWriter
 *
...
namespace corryvreckan {
     ...
     */
    class AhcalTextWriter : public Module {
    ...
    public:
         ...
         */
        AhcalTextWriter(Configuration& config, std::vector<std::shared_ptr<Detector>> detectors);
