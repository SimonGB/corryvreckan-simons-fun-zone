/**
 * @file
 * @brief Definition of module TrackingMultipletTree
 *
...
#ifndef CORRYVRECKAN_TrackingMultipletTree_H
#define CORRYVRECKAN_TrackingMultipletTree_H 1
...
namespace corryvreckan {
    ...
    class TrackingMultipletTree : public Module {

    public:
        // Constructors and destructors
        TrackingMultipletTree(Configuration& config, std::vector<std::shared_ptr<Detector>> detectors);
    ...
    private:
        ...
        TH2F* multipletKinkAtScattererXvsGlobalXY;
        TH2F* multipletKinkAtScattererYvsGlobalXY_larger50;
        TH2F* multipletKinkAtScattererYvsGlobalXY;
        TH2F* multipletKinkAtScattererXvsGlobalXY_larger50;

        TH2F* multipletRegisteredAtScatterer;
        TH2F* multipletRegisteredAtScattererX_larger50;
...
#endif // CORRYVRECKAN_TrackingMultipletTree_H
